<section>
    ...
    <form method="post" action="{{ route('password.update') }}" class="mt-8 space-y-6">
        ...
        <div>
            <label for="update_password_current_password" class="block text-xs font-black text-slate-500 uppercase tracking-widest pl-1 mb-2">Kata Sandi Saat Ini</label>
        ...
        <div>
            <label for="update_password_password" class="block text-xs font-black text-slate-500 uppercase tracking-widest pl-1 mb-2">Kata Sandi Baru</label>
        ...
        <div>
            <label for="update_password_password_confirmation" class="block text-xs font-black text-slate-500 uppercase tracking-widest pl-1 mb-2">Konfirmasi Kata Sandi Baru</label>
