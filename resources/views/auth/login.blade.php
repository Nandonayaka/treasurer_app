    ...
    <div class="flex flex-col md:flex-row min-h-screen bg-white md:bg-slate-50 font-plus-jakarta overflow-hidden" 
        ...
        <div class="flex-1 bg-white -mt-12 md:mt-0 rounded-t-[3rem] md:rounded-none px-8 pt-10 pb-12 relative z-20 flex flex-col justify-center order-last">
            <div class="w-full max-w-[440px] mx-auto relative flex flex-col justify-center">
                ...
                <!-- LOGIN FORM -->
                <div x-show="isLogin" x-transition:enter="transition-all ease-out duration-300" x-transition:enter-start="opacity-0 scale-95" x-transition:enter-end="opacity-100 scale-100" data-aos="fade-up" data-aos-delay="1000">
                ...
                <!-- REGISTER FORM -->
                <div x-show="!isLogin" x-transition:enter="transition-all ease-out duration-300" x-transition:enter-start="opacity-0 scale-95" x-transition:enter-end="opacity-100 scale-100" x-cloak>
